...
export class ChatGroupsController {
  ...
  @ApiNotFoundResponse({
    ...
    schema: {
      example: {
        "message": "El creador con id 1f452184-8889-4caa-989a-494e5b7a1e25 no se ha encontrado.",
        "error": "Not Found",
        "statusCode": 404
      }
    }
  ...
  @ApiInternalServerErrorResponse({
    ...
    schema: {
      example: {
        "message": "Ocurrió un error al ejecutar la solicitud. Revise los datos e intente nuevamente.",
  ...
  @ApiOkResponse({ description: 'Chat-Groups deleted successfully.', schema: { example: 'Chat de grupo con id ${id} borrado de forma exitosa.' } })
  @ApiBadRequestResponse({

...
import { ApiBadRequestResponse, ApiCreatedResponse, ApiInternalServerErrorResponse, ApiNotFoundResponse, ApiOkResponse, ApiOperation, ApiTags, ApiUnprocessableEntityResponse } from '@nestjs/swagger';
...
export class GroupMembersController {
  ...
  @ApiNotFoundResponse({
    ...
    schema: {
      example: {
        "message": "El grupo de chat con el id 148d0f81-4e76-4770-a549-514cc7c0ef94 no fue encontrado.",
        "error": "Not Found",
        "statusCode": 404
      }
    }
  ...
  @ApiOkResponse({
    ...
    schema: {
      example: {
        "message": "El rol del miembro con id 1f452184-8889-4caa-989a-494e5b7a1e2c en el grupo 148d0f81-4e76-4770-a549-514cc7c0ef9d ha sido actualizado a ADMIN"
      }
    }
  })
  @ApiUnprocessableEntityResponse({
    ...
    schema: {
      example: {
        "message": "El rol que se le quiere asignar al usuario con id 1f452184-8889-4caa-989a-494e5b7a1e2c es el mismo rol que ya tiene asignado.",
  ...
  @ApiNotFoundResponse({
    ...
    schema: {
      example: {
        "message": "El usuario con el id 1f452184-8889-4caa-989a-494e5b7a1e2c no se encuentra en el grupo con id 148d0f81-4e76-4770-a549-514cc7c0ef9C.",
        "error": "Not Found",
        "statusCode": 404
      }
    }
  ...
  @ApiNotFoundResponse({
    ...
    schema: {
      example: {
        "message": "Solicitud con ID 148d0f81-4e76-4770-a549-514cc7c0ef9d no encontrada.",
        "error": "Not Found",
        "statusCode": 404
      }
    }
